...
public class Config {
    ...
    public static void from(Config cfg, Map<String, Object> yamlConfig) throws MalformedObjectNameException {
        ...
        if (yamlConfig.containsKey("consulHost")) {
            cfg.consulHost = (String) yamlConfig.get("consulHost");
        }

        if (yamlConfig.containsKey("consulPort")) {
            cfg.consulPort = (Integer) yamlConfig.get("consulPort");
        }
